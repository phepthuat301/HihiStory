...
/*function action(mode, type, selection) {
    ...
    if (mode != 1) {
        ...
        if (mode == 0 && status == 1) {
                var selStr = "Where? <3 #b";
                options0 = ["Henesys","Perion","Ellinia","Kerning City","Sleepywood"];
            ...
            if (status == 0) {
                ...
                if (selected == 1)
                {
                    ...
                    if (selection == 0)
                    {
                        ...
                        //cm.sendOk(" 1___Not coded yet, f4."); 
                ...
                if (selectedShopXu == 1)
                {
                        ...
                        if (cm.getDonatePoints() >= 100) {
                            cm.gainItem(item[selection], 1);
                            cm.gainDonatePoints(100);
